...
export GOPATH=~/go
export PATH="$HOME/.npm-global/bin:/opt/homebrew/opt/mysql-client/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:$GOROOT/bin:$GOPATH/bin:$HOME/.cargo/bin:/usr/local/opt/libpq/bin/:$HOME/.local/bin:/opt/homebrew/bin"
